...
Documentation that covers the current behavior and features in the Haze Demo (**v0.2.0**).
...
- [Color](3-color.md) - the HSV picker, hex, swatches, eyedropper, the shared foreground color, and the **Gradient** tool
